...
namespace Blok\Friendable\Traits;

use Blok\Friendable\Models\Friendship;
use Blok\Friendable\Models\FriendFriendshipGroups;
use Blok\Friendable\Status;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Support\Facades\Event;

/**
 * Class Friendable
 * @package Blok\Friendable\Traits
 */
trait Friendable
{
    /**
     ...
     *
     * @return \Blok\Friendable\Models\Friendship|false
     */
    ...
    public function groupFriend(Model $friend, $groupSlug)
    {
        ...
        $group = $friendship->friendsfriendsGroups()->firstOrCreate([
    ...
    public function ungroupFriend(Model $friend, $groupSlug = '')
    {
        ...
        $result = $friendship->friendsGroups()->where($where)->delete();
     ...
     * @param Model $recipient
     *
     * @return \Blok\Friendable\Models\Friendship
     */
...
//        );
     ...
     * @return \Illuminate\Database\Eloquent\Relations\MorphMany
     */
    public function friendsfriendsGroups()
    {
